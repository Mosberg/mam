...
public class ModBlocks {
    ...
    public static final Block PERSONAL_MANA_CRYSTAL = registerBlock("personal_mana_crystal",
            new ManaCrystalBlock(ManaPoolType.PERSONAL,
                    AbstractBlock.Settings.create().mapColor(MapColor.CYAN).luminance(state -> 12)
    ...
    public static final Block AURA_MANA_CRYSTAL = registerBlock("aura_mana_crystal",
            new ManaCrystalBlock(ManaPoolType.AURA,
                    AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).luminance(state -> 12)
                            .strength(3.0f, 9.0f).sounds(BlockSoundGroup.AMETHYST_BLOCK)
                            .pistonBehavior(PistonBehavior.BLOCK)));

    public static final Block RESERVE_MANA_CRYSTAL = registerBlock("reserve_mana_crystal",
            new ManaCrystalBlock(ManaPoolType.RESERVE,
                    AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).luminance(state -> 12)
                            .strength(3.0f, 9.0f).sounds(BlockSoundGroup.AMETHYST_BLOCK)
                            .pistonBehavior(PistonBehavior.BLOCK)));

    // Ritual Pedestal - central block for ritual casting
    public static final Block RITUAL_PEDESTAL = registerBlock("ritual_pedestal",
            new RitualPedestalBlock(AbstractBlock.Settings.create().mapColor(MapColor.BLACK)
                    .luminance(state -> 8).strength(5.0f, 12.0f).sounds(BlockSoundGroup.STONE)
    ...
    public static final Block RITUAL_CANDLE = registerBlock("ritual_candle",
            new RitualCandleBlock(AbstractBlock.Settings.create().mapColor(MapColor.WHITE)
    ...
    public static final Block MANA_INFUSED_STONE = registerBlock("mana_infused_stone",
            new Block(AbstractBlock.Settings.create().mapColor(MapColor.LAPIS_BLUE)
                    .luminance(state -> 4).strength(2.0f, 6.0f).sounds(BlockSoundGroup.STONE)));

    public static final Block MANA_INFUSED_STONE_BRICKS = registerBlock("mana_infused_stone_bricks",
            new Block(AbstractBlock.Settings.create().mapColor(MapColor.LAPIS_BLUE)
                    .luminance(state -> 4).strength(2.5f, 7.0f).sounds(BlockSoundGroup.STONE)));

    // Arcane Altar - crafting block for magical items
    public static final Block ARCANE_ALTAR =
            registerBlock("arcane_altar",
                    new ArcaneAltarBlock(AbstractBlock.Settings.create().mapColor(MapColor.PURPLE)
                            .luminance(state -> 10).strength(4.0f, 10.0f)
